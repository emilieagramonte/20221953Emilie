...
typedef struct              /*Declaracion de la estructura alumno. */
{
    ...
    - la estructura definida en  primer termino. */
...
void main (void)
{
    ...
    while (TAM > 50 || TAM < 1);    /* Se verifica que el tamano sea correcto. */
    Lectura (ALU, TAM);
    F1(ALU, TAM);
    F2(ALU, TAM);
    F3(ALU, TAM);
...
/* Esta funcion se utiliza para leer la informacion de un arreglo unidimensional de tipo estriuctura alumno de T alementos. */
{
    int I, J;
    for (I=0; I<J; I++)
    {
