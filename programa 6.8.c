...
void Transpuesta(int [][MAX], int, int);  /*Prototipos de funciones. */
...
void main (void)
{
    ...
    while (COL > MAX || COL < 1);
    /* Se verifica que el numero de columnas sea corrector. */
    Lectura(MAT, FIL, COL);
...
void Transpuesta(int M1[][MAX], int F, int C)
...
/*Esta funcion se utiliza para escribir una matriz se tipo entero de F filas
