...
int main (void)
{
    ...
    printf{"\nEl elemento se encuetra en la posicion: %d", RES};
    else
        printf("\nEl elemento no se encuebtra en la posicion: %d", RES);
    else
...
elemento  E en el arreglo unidimensional A de T elementos, Si se encuentra
el elemento, la funcion regresa la posicion correspondiente.
