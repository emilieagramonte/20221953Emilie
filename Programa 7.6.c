...
➥un error en la ejecución del programa. */
     ...
     strncpy(cad2, cad0, 4);
     cad2[3] = '\0';
     printf("\nPrueba de la funcion strncpy. Se copian 3 caracteres de cad2 a cad2: %s\n", cad2);
...
➥primera ocurrencia de la cadena localizada. De otra forma, regresa NULL. */
      ...
      printf("\nPrueba de la funcion strstr. Se trata de localiza la cadena Guatemala dentro de cad0: %s\n", cad0);
}
