...
/* Suma de matrices.
El programa, al recibir com datos arreglos bidimensionales del mismo
...
/*La funcion Imprime se utiliza para escribir un arreglo bidimensional de
tipo entero de F filas y C columnas. */
{
    int I, J;
    for (I=0; I<F; J++)
        for (J=0; J<C; J++)
