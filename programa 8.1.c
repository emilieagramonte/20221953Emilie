...
/* Estructuras -1.
El programa muestra la manera en la que se declara una estructura, asi como la forma
en que se tiene acceso a los campos de las variables de un tipo de estructura
...
void main (void)
{
     /*Observa que las variables de tipo estructura se declara como cualquier otra variable.
     a1, a2 y a3 s\son variables de tipo estructura alumno. */
     ...
     int mat;
     float pro;
     /* Los campos a2 reciben valores por medio de una lectura. */
     ...
     /* Observa ptra forma de escribir los campos de la variable de tipo estructura a3. */
