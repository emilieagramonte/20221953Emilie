#include<stdio.h>
 ...
 pluvial en los ultimos 10 anos. Escribe ademas el registro correspondiente. */
  ...
  /*Esta funcion se utiliza para loxalizar la provincia que tuvo el menor registro de lluvias
  en el ultimo ano. Escribe ademas el registro correspondiente. */
  {
      int I, J, EMEN;
      float ELLU = 1000, SUM;
      for (I=0; I<F; I++)
  ...
  /* Esta funcion se utiliza para localizar el mes con mas registros de lluvias en la provincia
  18 en el quinto ano. Escribe ademas el registro correspondiente. */
  {
      int J, EMES = -1;
      float ELLU = -1.0;
      for (J=0; J<C; J++)
