...
void main (void)
{
    ...
    /* Esta funcion se utiliza para leer in arreglo bidimensional de tipo real de F filas y C columnas.*/
    {
        int I, J;
        for (I=0; I<F; I++)
            for (J=0; J<C; J++)
...
{
    /* La funcion F1 se utiliza para calcular el rendimiento anual de lo sfondos de inversion.
...
{
    /*Esta funcion calcula el promedio anualizado de las acciones de diferentes fondos. */
    int I, J;
    float SUM, PRO;
...
/* Esta funcion permite calcular los fondos con el mejor y peor rendimineto. */
{
    float ME = A[0], PE  = A[0];
    int  M = 0, P = 0, I;
    for (I=1; I<F; I++)
