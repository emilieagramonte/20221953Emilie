...
void main (void)
{
    ...
    do
    {
        printf("Ingrese el numero de alumnos de grupo: ");
        scanf("%d", &NAL);
...
/*Esta funcion se utiliza para obyener el promedio de cada estudiante. */
{
    int I, J;
    float SUM, PRO;
    for (I=0; I<T; I++)
    {
        ...
        for (J=0; J<EXA; J++)
            SUM += A[I][J];
        PRO = SUM / EXA;
        printf("\nEl promedio del alumno %d es: %5.4f", I+1, PRO);
    }
}
...
como también el examen que obtuvo el promedio más alto. */
{
        ...
        printf("\N El promedio del examen %d es: %f", J+1, PRO);
        }
