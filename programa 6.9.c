...
en funcion modulo (residuo) a un arreglo unidimensional. */
...
/*Esta funcion se utiliza tanto para calcular el modulo entre el indice del arreglo unidimensional y 3, como para llamar a las funciones
...
/* Esta funcion se utiliza para escribir un arreglo unidimensional de tipo real
de N elementos. */
{
    int I;
    for (I=0; I<N; I++)
