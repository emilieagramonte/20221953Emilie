...
/* Uniones.
El programa muestra la manera como se declara la union, asi como la forma de acceso a los campos
de las variables de tipo union tanto para la asignacio de valores como para lectura y escritura. */
...
/* Para que puedas observar las diferentes formas en los que los campos de las
variables de tipo de estructura alumno reciben valores, ingresamos los valores
...
puts(a2.personales.correo);          /* Escribe el contenidp del segundo campo. */
