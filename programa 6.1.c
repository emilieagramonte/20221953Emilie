...
/*Observa que siempre es necesario declarar el numero de columnas. S i no lo haces,
...
/* La funcion Imprime se utiliza para escribir un arreglo bidimensional cuadrado de F files y columnas. */
{
    int I, J;
    for (I=0; I<F; I++)
        for (J=0; J<TAM; J++)
        if (I == J)
    printf("n\Diagonal %d %d: %d", I, J, A[I][J]);
}
